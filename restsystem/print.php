...
<div class="container" align="center">
  <div class="content" >
    <table width="800" border="1"  cellpadding="2" style="background-color:#FFF">
      <tr>
        <td height="71" colspan="2"><p align="center" style="font-size:28px" ><strong >XXXXX股份有限公司 </strong></p>
        <p align="center" style="font-size:24px"><strong>請假單</strong></p></td>
       
      </tr>
      <tr>
        <td width="383" id="applyer">申請人:</td>
        <td width="397">職稱:</td>
      </tr>
      <tr>
        <td height="41" colspan="2" id="offtime" >請假時間:</td>
        
      </tr>
      <tr>
        <td height="41" id="cat">假別:</td>
        <td id="agent">職務代理人:</td>
      </tr>
      <tr>
      ...
      <tr>
        <td height="41" colspan="2" id="applydate" align="center">申請日期:</td>
  ...
  <?php
	...
	date_default_timezone_set('Asia/Taipei');
	  ...
	  //以下日期轉民國年
	 // $start_mingo=new DateTime($start);
	//  $end_mingo=new DateTime($end);
	  //$today_mingo=new DateTime($today);
	  
	  $start_m=explode('-',$start);
	  $end_m=explode('-',$end);
	  $today_m=explode('-',$today);
	  ...
	  echo '<script>';
	 echo '$("#offtime").html("請假時間: 自民國 '.$start_mingo.'年 '.$start_m[1].'月'. str_replace(" ","日  ",$start_m[2]).'<br>&emsp;&emsp;&emsp;&emsp;&emsp;至民國 '.$end_mingo.'年 '.$end_m[1].'月'. str_replace(" ","日  ",$end_m[2]).' 共 '.$days.' 天");';
	// echo '$("#offtime").text("請假時間: '.$start.'~\n\n'.$end.' 共'.$days.'天");';
	  echo '$("#applyer").text("申請人: '.$username.'");';
	  
	  echo '$("#cat").text("假別: '.$cat.'");';
	  echo '$("#agent").html("職務代理人: '.$agent.'&nbsp;(&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp; <font size=1>請代理人親簽</font>)");';
	  echo '$("#applydate").text("申請日期: 民國 '.$today_mingo.' 年 '.$today_m[1].' 月 '.$today_m[2].' 日");';
	  echo '</script>';
